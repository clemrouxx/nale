...
function CitationDropDown({editor}){
  ...
  return (
    ...
    <DropDown buttonClassName="toolbar-item" buttonLabel={"Cite..."} chevron={false} buttonIconClassName={"citation"}>
      ...
      {biblio.sort((a,b)=>a.title.localeCompare(b.title)).map(bibitem => (
      ...
      <div className='toolbar-itemgroup'>
        ...
        <div className="toolbar-itemgroup">
          <DropDown
            ...
            <DropDownItemWithIcon title={"Page break"} onClick={() => activeEditor.update(() => $insertNodes([$createPageBreakNode()]))} iconClassName={"page-break"}/>
          </DropDown>
        </div>
