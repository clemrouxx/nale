...
export class MathNode extends StylableNode {
  ...
  static clone(node) {
    return new MathNode(node.__inline,structuredClone(node.__math_tree),this.__version_counter,node.__is_numbered,node.__label_number,node.__style,node.__key);
  }
